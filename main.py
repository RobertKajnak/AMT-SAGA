...
if __name__ == '__main__':
    ...
    parser.add_argument('-models',
                        ...
                        '5= FFT Instrument Classifier w/ adaptive swindow log10 scaled'
                        '6= FFT Instrument Classifier w/ constant swindow '
                        '7= FFT Instrument Classifier w/ constant swindow log10 scaled'
                        '8= CQT+FFT Instrument Classifier '
                        '9= mag + phase Instrument Classifier '
                        '10= CQT Instrument Classifier w/ adaptive swindow '
                        '11= CQT Instrument Classifier w/ constant swindow '
                        '12= CQT+CQT Instrument Classifier '
                        '13= Velocity detector '
